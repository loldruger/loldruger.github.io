...
const template = () => {
    ...
    const a = DOMComposer.new({ tag: 'div' })
        ...
        .appendChild(DOMComposer.new({ tag: 'button' })
            ...
            .appendChild(DOMComposer.newRaw({ tag: 'svg', rawAttributes: `id="sun" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" version="1.1" width="17" height="17" viewBox="0 0 17 17"` })
        ...
        .appendChild(DOMComposer.new({ tag: 'button' })
            ...
            .setAttribute({ name: 'class', value: 'flexbox circle align-center-h align-center-v mr-2' })
            .setAttribute({ name: 'type', value: 'image' })
            .appendChild(DOMComposer.newRaw({ tag: 'svg', rawAttributes: `id="lang-ko" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" version="1.1" width="17" height="17" viewBox="0 0 17 17"` })
