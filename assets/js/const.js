 ...
 * @param {string} resume.lastUpdate - The last update date of the resume.
...
const getResume = (resume) => {
    ...
    resumeComposed.push(sectionFrame(profileBlock()[0], profileBlock()[1]));
    resumeComposed.push(sectionFrame(eduBlock()[0], eduBlock()[1]));
    resumeComposed.push(sectionFrame(workExp()[0], workExp()[1]));
